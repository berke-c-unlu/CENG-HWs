...
def create_distances(graphKeys):
    distances = {}
    for key in graphKeys:
        distances[key] = 10**8
    return distances
...
def UCS(graph,start,end):
    ...
    # distances
    distances = create_distances(graph.keys())
    ...
    while True:
        ...
        currentNode = create_cost_and_coord_pair(maxpri[0],[maxpri[1][0],maxpri[1][1]])
