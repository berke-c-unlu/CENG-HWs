...
#define INPUT_PATH "/Users/bugra/Desktop/courses/ceng477/the2/inputs_outputs/culling_disabled_inputs/sample.xml"
...
int main(int argc, char *argv[])
{
    ...
    else
    {
        ...
        cout << "There are " << scene->cameras.size() << " cameras" << endl;
